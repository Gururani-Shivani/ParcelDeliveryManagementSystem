...
using Xunit;
using ParcelDeliveryManagement.UnitTests.TestBase;

namespace ParcelDeliveryManagement.UnitTests
{
    public class ParcelTest:Base

    {
        ...
        public void LowWeight_LowValue_Parcel_ShouldBeHandled_ByEmailDepartment(double weight, double value)
        {
            ...
            {
                Sender = SampleData.SampleCompany,
                Recipient = SampleData.SamplePerson,
                Weight = weight,
                Value = value
            };
